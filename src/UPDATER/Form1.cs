    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                wb.DownloadFileAsync(new Uri("https://sky880319.github.io/lrcmaker/LRCMaker.exe"), Application.StartupPath + "\\LRCMaker.exe");
            }
            catch (Exception ex)
            {
                label1.Text = "請至官網重新下載程式\n" + ex.ToString();
                haserror = true;
            }
        }
        ...
        private void DownloadFileProcess(object sender, DownloadProgressChangedEventArgs e)
        {
            ...
            label1.Text = "正在從網路上取得資料..." + dwsize.ToString() + "/" + filsize.ToString();
        }
